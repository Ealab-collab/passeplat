...
<html-builder data-url="/forms/navbar.php?wsid=<?php echo $wsid; ?>&activeTab=dashboard"
              data-method="POST">
</html-builder>

<html-builder data-url="http://localhost/forms/dashboard.php?wsid=<?php echo $wsid; ?>"
              data-method="POST">
</html-builder>
</body>
</html>
