...
/**
 * Condition which checks the JSON body of the request.
 */
class RequestJsonBodyCondition_0 extends JsonBodyConditionBase_0
{
    ...
    protected function getPluginDescription(): array
    {
        ...
        $description['publicName'] = 'Corps de la requête (JSON)';
        $description['id'] = 'request_json_body';
        return $description;
    }
